...
if plot_foot_boolean == 1
    ...
    subplot(2,1,1)
    area(time_unique - t0, right_heel_contact_bool_signal, 'FaceColor', red, 'EdgeColor', black, 'FaceAlpha', 0.5, 'LineWidth', 1);
    ylabel('Heel', 'Interpreter', 'latex', 'FontSize', y_font_size);
    xlim([0, time_unique(end) - t0]);
    set(gca, 'YTick', [0,1], 'FontSize', tick_font_size);
    subplot(2,1,2)
    area(time_unique - t0, right_toe_contact_bool_signal, 'FaceColor', red, 'EdgeColor', black, 'FaceAlpha', 0.5, 'LineWidth', 1);
    ylabel('Toe', 'Interpreter', 'latex', 'FontSize', y_font_size);
    xlim([0, time_unique(end) - t0]);
    set(gca, 'YTick', [0,1], 'FontSize', tick_font_size);
end
