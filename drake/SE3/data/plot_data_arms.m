...
% Load the csv data
data = csvread('data_SE3_arms.csv');
joy = csvread('data_joystick.csv');
...
if plot_joy == 1
    ...
    vx_command = joy(:,2) * vx_max;
    vy_command = joy(:,1) * vy_max;
    wz_command = joy(:,3) * wz_max;
    z_command = joy(:,5) * (z_lower - z_upper) + z_upper;
